...
import type { AncientGameOptions } from "../../../../../src/game/schemas/game-options/roles-game-options/ancient-game-options.schema";
import type { PiedPiperGameOptions } from "../../../../../src/game/schemas/game-options/roles-game-options/pied-piper-game-options.schema";
import type { RolesGameOptions } from "../../../../../src/game/schemas/game-options/roles-game-options/roles-game-options.schema";
import type { SeerGameOptions } from "../../../../../src/game/schemas/game-options/roles-game-options/seer-game-options.schema";
import type { SheriffGameOptions } from "../../../../../src/game/schemas/game-options/roles-game-options/sheriff-game-options/sheriff-game-options.schema";
import type { ThiefGameOptions } from "../../../../../src/game/schemas/game-options/roles-game-options/thief-game-options.schema";
