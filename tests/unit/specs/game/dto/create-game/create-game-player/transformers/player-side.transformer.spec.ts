import type { CreateGamePlayerSideDto } from "../../../../../../../../src/game/dto/create-game/create-game-player/create-game-player-side.dto/create-game-player-side.dto";
import { playerSideTransformer } from "../../../../../../../../src/game/dto/create-game/create-game-player/transformers/player-side.transformer";
...
describe("Player Side Transformer", () => {
  describe("playerSideTransformer", () => {
    it("should fill player side with werewolf data when role is white werewolf.", () => {
      ...
      expect(playerSideTransformer({ value: {}, obj: player })).toStrictEqual<CreateGamePlayerSideDto>({
