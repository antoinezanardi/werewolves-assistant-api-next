...
describe("Game Plays Validator Service", () => {
  ...
  describe("validateGamePlayWithRelationsDtoData", () => {
    ...
    beforeEach(() => {
      validateGamePlayWithRelationsDtoJudgeRequestDataSpy = jest.spyOn(service as unknown as { validateGamePlayWithRelationsDtoJudgeRequestData }, "validateGamePlayWithRelationsDtoJudgeRequestData").mockImplementation();
      validateGamePlayWithRelationsDtoChosenSideDataSpy = jest.spyOn(service as unknown as { validateGamePlayWithRelationsDtoChosenSideData }, "validateGamePlayWithRelationsDtoChosenSideData").mockImplementation();
      validateGamePlayVotesWithRelationsDtoDataSpy = jest.spyOn(service as unknown as { validateGamePlayVotesWithRelationsDtoData }, "validateGamePlayVotesWithRelationsDtoData").mockImplementation();
      validateGamePlayTargetsWithRelationsDtoDataSpy = jest.spyOn(service as unknown as { validateGamePlayTargetsWithRelationsDtoData }, "validateGamePlayTargetsWithRelationsDtoData").mockImplementation();
      validateGamePlayWithRelationsDtoChosenCardDataSpy = jest.spyOn(service as unknown as { validateGamePlayWithRelationsDtoChosenCardData }, "validateGamePlayWithRelationsDtoChosenCardData").mockImplementation();
  ...
  describe("validateGamePlayWitchTargets", () => {
    ...
    it("should call potions validators without players when called with valid data but no target.", () => {
      const validateDrankLifePotionTargetsSpy = jest.spyOn(service as unknown as { validateDrankLifePotionTargets }, "validateDrankLifePotionTargets").mockImplementation();
      const validateDrankDeathPotionTargetsSpy = jest.spyOn(service as unknown as { validateDrankDeathPotionTargets }, "validateDrankDeathPotionTargets").mockImplementation();
      const game = createFakeGame({ upcomingPlays: [{ action: GAME_PLAY_ACTIONS.USE_POTIONS, source: ROLE_NAMES.WITCH }] });
      const makeGamePlayTargetsWithRelationsDto = [];
  ...
  describe("validateGamePlayWerewolvesTargets", () => {
    ...
    beforeEach(() => {
      validateGamePlayTargetsBoundariesMock = jest.spyOn(service as unknown as { validateGamePlayTargetsBoundaries }, "validateGamePlayTargetsBoundaries").mockImplementation();
    });
  ...
  describe("validateGamePlayRoleTargets", () => {
    it("should call targets validators when called.", () => {
      const validateGamePlaySheriffTargetsMock = jest.spyOn(service as unknown as { validateGamePlaySheriffTargets }, "validateGamePlaySheriffTargets").mockImplementation();
      const validateGamePlayGuardTargetsMock = jest.spyOn(service as unknown as { validateGamePlayGuardTargets }, "validateGamePlayGuardTargets").mockImplementation();
      const validateGamePlayPiedPiperTargetsMock = jest.spyOn(service as unknown as { validateGamePlayPiedPiperTargets }, "validateGamePlayPiedPiperTargets").mockImplementation();
      const validateGamePlayWildChildTargetsMock = jest.spyOn(service as unknown as { validateGamePlayWildChildTargets }, "validateGamePlayWildChildTargets").mockImplementation();
      const validateGamePlayRavenTargetsMock = jest.spyOn(service as unknown as { validateGamePlayRavenTargets }, "validateGamePlayRavenTargets").mockImplementation();
      const validateGamePlaySeerTargetsMock = jest.spyOn(service as unknown as { validateGamePlaySeerTargets }, "validateGamePlaySeerTargets").mockImplementation();
      const validateGamePlayFoxTargetsMock = jest.spyOn(service as unknown as { validateGamePlayFoxTargets }, "validateGamePlayFoxTargets").mockImplementation();
      const validateGamePlayCupidTargetsMock = jest.spyOn(service as unknown as { validateGamePlayCupidTargets }, "validateGamePlayCupidTargets").mockImplementation();
      const validateGamePlayScapegoatTargetsMock = jest.spyOn(service as unknown as { validateGamePlayScapegoatTargets }, "validateGamePlayScapegoatTargets").mockImplementation();
      const validateGamePlayHunterTargetsMock = jest.spyOn(service as unknown as { validateGamePlayHunterTargets }, "validateGamePlayHunterTargets").mockImplementation();
      const validateGamePlayWerewolvesTargetsMock = jest.spyOn(service as unknown as { validateGamePlayWerewolvesTargets }, "validateGamePlayWerewolvesTargets").mockImplementation();
      const validateGamePlayInfectedTargetsMock = jest.spyOn(service as unknown as { validateGamePlayInfectedTargets }, "validateGamePlayInfectedTargets").mockImplementation();
      const validateGamePlayWitchTargetsMock = jest.spyOn(service as unknown as { validateGamePlayWitchTargets }, "validateGamePlayWitchTargets").mockImplementation();
  ...
  describe("validateGamePlayTargetsWithRelationsDtoData", () => {
    ...
    beforeEach(() => {
      validateGamePlayInfectedTargetsSpy = jest.spyOn(service as unknown as { validateGamePlayInfectedTargets }, "validateGamePlayInfectedTargets").mockImplementation();
      validateGamePlayWitchTargetsSpy = jest.spyOn(service as unknown as { validateGamePlayWitchTargets }, "validateGamePlayWitchTargets").mockImplementation();
      validateGamePlayRoleTargetsSpy = jest.spyOn(service as unknown as { validateGamePlayRoleTargets }, "validateGamePlayRoleTargets").mockImplementation();
    });
